function OpeningCeremony(callbackFunction) {
  console.log("Let the games begin!");
  const score = { red: 0, yellow: 0, blue: 0, green: 0 };
  setTimeout(() => {
    Race100M(score, callbackFunction);
  }, 1000);
}

function Race100M(score, callbackFunction) {
  ...
  setTimeout(() => {
    ...
    callbackFunction(score, LongJump);
  }, 3000);
}

function LongJump(score, callbackFunction) {
  ...
  setTimeout(() => {
    callbackFunction(score, HighJump);
  }, 2000);
}
...
function AwardCeremony(score) {
  ...
  console.log(
    `Participant at 1st place: ${sortedScores[0][0]} with ${sortedScores[0][1]} points`
  );
  console.log(
    `Participant at 2nd place: ${sortedScores[1][0]} with ${sortedScores[1][1]} points`
  );
  console.log(
    `Participant at 3rd place: ${sortedScores[2][0]} with ${sortedScores[2][1]} points`
  );
}
